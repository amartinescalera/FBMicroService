...
describe('Get User Test', function() {
  it('Get a User', (done) => {
    ...
    scope = nock('https://graph.facebook.com', {
      reqheaders: {
        'Authorization': 'OAuth CAAJp5SmLmN8BAFAi6ZBCSH51RDDqhsqJH4z6uzYU4Un' +
        'k3U45tjQrLw29g6ZBqB8FbNXGVPi70wKtHsBsiy',
        'Content-Type': 'application/json'
      }
    })
      .get('/v2.4/me?fields=id,name,friends,pictur' +
        'e&appsecret_proof=5d124ca0c528a34b1d9da05e738cd11736ab9f9b3' +
        'cd3c6a9b10a279c91ecd472')
      .reply(200, res);

    let options = {
      method: 'GET',
      url: '/user/CAAJp5SmLmN8BAFAi6ZBCSH51RDDqhsqJH4z6uzYU4Unk3U45tjQrLw29g6' +
      'ZBqB8FbNXGVPi70wKtHsBsiy/me'
    };
  ...
  it('Get a error with an user', (done) => {
    ...
    let res = {
      'error': {
        ...
        'created or Facebook has changed the session for ' +
        'security reasons.',
        'type': 'OAuthException',
        'code': 190,
        'errorSubcode': 460,
    ...
    scope = nock('https://graph.facebook.com', {
      reqheaders: {
        'Authorization': 'OAuth CAAJp5SmLmN8BAFAi6ZBCSH51RDDqhsqJH4z6uzYU' +
        '4Unk3U45tjQrLw29g6ZBqB8FbNXGVPi70wKtHsBsiy',
        'Content-Type': 'application/json'
      }
    })
  ...
  it('Get an unknowerror', (done) => {
    ...
    let options = {
      method: 'GET',
      url: '/user/CAAJp5SmLmN8BAFAi6ZBCSH51RDDqhsqJH4z6uzYU4Unk3U45tjQrLw29g' +
      '6ZBqB8FbNXGVPi70wKtHsBsiy/me'
    };
